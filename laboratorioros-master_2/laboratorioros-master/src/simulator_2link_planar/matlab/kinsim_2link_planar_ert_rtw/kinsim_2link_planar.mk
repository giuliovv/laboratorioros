...
## Generated on : Wed May 06 12:18:27 2020
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/kinsim_2link_planar.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/kinsim_2link_planar.elf
...
DEFINES_ = -DMODEL=kinsim_2link_planar -DNUMST=2 -DNCSTATES=3 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=1 -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DROS_PROJECT -DMW_SCHED_OTHER -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT=RT
DEFINES_BUILD_ARGS = -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0
DEFINES_CUSTOM = 
DEFINES_OPTS = -DTID01EQ=1
DEFINES_SKIPFORSIL = -DROS_PROJECT -DMW_SCHED_OTHER -DSTACK_SIZE=64
DEFINES_STANDARD = -DMODEL=kinsim_2link_planar -DNUMST=2 -DNCSTATES=3 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = kinsim_2link_planar.cpp.o kinsim_2link_planar_data.cpp.o linuxinitialize.cpp.o slros_busmsg_conversion.cpp.o slros_initialize.cpp.o slros_generic_param.cpp.o
...
%.c.o : $(START_DIR)/kinsim_2link_planar_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.s.o : $(START_DIR)/kinsim_2link_planar_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<


%.cpp.o : $(START_DIR)/kinsim_2link_planar_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
kinsim_2link_planar.cpp.o : $(START_DIR)/kinsim_2link_planar_ert_rtw/kinsim_2link_planar.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


kinsim_2link_planar_data.cpp.o : $(START_DIR)/kinsim_2link_planar_ert_rtw/kinsim_2link_planar_data.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
slros_busmsg_conversion.cpp.o : $(START_DIR)/kinsim_2link_planar_ert_rtw/slros_busmsg_conversion.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


slros_initialize.cpp.o : $(START_DIR)/kinsim_2link_planar_ert_rtw/slros_initialize.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
